...
| The bump, live (2026-08-14) | **PARTIAL.** The governor never braked the creep — 476/476 ticks at full speed — and A closed to 0.2252 m against a 0.2175 m contact, from 0.3455 m before. **Neither witness noticed**: wheels read 0.0510 m/s while pressed against B, laser ε came from a parked robot and is four times under the matcher's creep noise | [Notes, nav artifact, bag analysis](bump-live/NOTES.md) |
