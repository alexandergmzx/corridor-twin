...
| The lens is the first instrument (2026-08-14, ADR 0035) | **Validated over six runs: zero faux launches, 6/6 reached the creep** (against 2/5 before), A→B spread 3.5 mm. Lens announced at +0 s, survives teardown, freeze proved over 3.5 h. **A map-degradation trend reported after four runs was REFUTED by the next two** and is withdrawn in the notes | [Notes, liveness records, six-run series](lens/first-instrument/NOTES.md) |
