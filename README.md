...
measured all four enforcement gates with a maximum speed error of 0.0331 m/s,
stayed compliant on the wide approach, and raised **exactly one** violation once
the corridor narrowed and the limit tightened — 0.195 m/s over the 0.80 m/s
corner rule, at station 10.0 m. A completed the 23.851 m route in 23.867 s of
simulation time using 3486 MiB of the RTX 5070 Ti and one render product, with
